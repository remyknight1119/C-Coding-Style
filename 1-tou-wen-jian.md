...
至于什么时候包含头文件，参见 [1.4 \#include 的路径及顺序 ](https://app.gitbook.com/@remyknight/s/c-coding-style/~/drafts/-Mki7hjiUyw37-6iw6vN/1-tou-wen-jian#14-include-de-lu-jing-ji-shun-xu)。
